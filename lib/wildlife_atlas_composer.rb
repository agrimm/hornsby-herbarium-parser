  ...
  def csv_output(filename)
    ...
    File.open(filename, "a") do |file|
      @hornsby_herbarium_spreadsheet.entries.each do |entry|
        values = [entry.relative_sequential_number,nil,nil,nil, entry.binomial, @hornsby_herbarium_spreadsheet.observation_date_string, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, @hornsby_herbarium_spreadsheet.location, nil, nil, nil, nil, nil, nil, nil, @hornsby_herbarium_spreadsheet.observers, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil].each do |cell|
          cell ||= ""
